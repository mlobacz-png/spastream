        ...
        <thead>
          <tr className="bg-slate-100">
            ...
            {competitors.map((comp, i) => (
              <th key={i} className={`p-4 text-center font-semibold ${comp.name === 'MedSpaFlow' ? 'bg-blue-50 text-blue-700' : 'text-slate-700'}`}>
                {comp.name}
              </th>
            ))}
          </tr>
  ...
  return (
    <Card className="border-0 shadow-2xl bg-gradient-to-br from-blue-50 to-cyan-50">
      <CardContent className="p-8">
        ...
        <p className="text-slate-600 mb-6">See how much MedSpaFlow can save your practice</p>
